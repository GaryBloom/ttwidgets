...
This gives a quick demo of the ttwidgets package, which improves a subset of
Tkinter widgets (Button, Label, Listbox), and provides a bonus ToolTip widget,
with support for multiple fonts and visual schemes.
...
from ttwidgets import cursor_s, frame_s, state_s, text_s
